...
namespace LivrariaAPI.Migrations
{
    ...
    [Migration("20210724195219_inicial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LivrariaAPI.Models.Author", b =>
                {
            ...
            modelBuilder.Entity("LivrariaAPI.Models.BookAuthor", b =>
                {
                    b.Property<int>("AuthorId")
                        .HasColumnType("int")
                        .HasColumnName("author_id");
            ...
            modelBuilder.Entity("LivrariaAPI.Models.Job", b =>
                {
            ...
            modelBuilder.Entity("LivrariaAPI.Models.Publisher", b =>
                {
                    b.Property<int>("PubId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LivrariaAPI.Models.Sale", b =>
                {
            ...
            modelBuilder.Entity("LivrariaAPI.Models.Store", b =>
                {
                    b.Property<string>("StoreId")
                        .HasMaxLength(4)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("LivrariaAPI.Models.Book", b =>
                {
                    b.HasOne("LivrariaAPI.Models.Publisher", "Pub")
                        .WithMany("Books")
                        .HasForeignKey("PubId")
            ...
            modelBuilder.Entity("LivrariaAPI.Models.BookAuthor", b =>
                {
                    b.HasOne("LivrariaAPI.Models.Author", "Author")
                    ...
                    b.HasOne("LivrariaAPI.Models.Book", "Book")
                        .WithMany("BookAuthors")
            ...
            modelBuilder.Entity("LivrariaAPI.Models.Sale", b =>
                {
                    ...
                    b.HasOne("LivrariaAPI.Models.Store", "Store")
                        .WithMany("Sales")
            ...
            modelBuilder.Entity("LivrariaAPI.Models.User", b =>
                {
                    b.HasOne("LivrariaAPI.Models.Job", "Job")
                        .WithMany("Users")
                        .HasForeignKey("JobId")
